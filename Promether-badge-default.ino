...
{
  colorWipe(0xff, 0x30, 0x00, 50);
  colorWipe(0x00,0x00,0x00, 50);  
}
else if(buttonPushCounter == 3)
{
  Sparkle(0x66, 0x00, 0x66, random(50,500));
}
else if(buttonPushCounter == 4)
{
  Twinkle(0xff, 0x30, 0x00, random(10,24), random(50,250), false);
}
else if(buttonPushCounter == 5)
{
  meteorRain(0x66, 0x00, 0x66, 4, 85, true, 50);
}
...
{
  SnowSparkle(0x00, 0x55, 0xff, 30, 50);
}
